...
import { SerialPreset, SerialConfig, NetworkConfig, ConnectionType } from '../types';
...
const PresetFormModal: React.FC<Props> = ({ 
  ...
  const [localConfig, setLocalConfig] = useState<SerialConfig>(initialData.config);
  const [localNetwork, setLocalNetwork] = useState<NetworkConfig>(initialData.network || { host: 'localhost', port: 8080 });
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-hidden flex flex-col">
          <CardContent className="pt-6 space-y-5 overflow-y-auto">
            ...
            <div className="flex justify-end">
                ...
                >
                    <ArrowDownCircle className="w-3.5 h-3.5 mr-1.5" /> Load Active Settings
                </Button>
            </div>
                ...
                <div className="grid grid-cols-2 gap-4 border p-3 rounded-md bg-muted/10">
                    <div className="space-y-1.5">
                        ...
                        <Select 
                            ...
                            onChange={(e) => handleSerialChange('baudRate', parseInt(e.target.value))}
                            className="h-8 text-xs bg-background"
                        >
                            {[9600, 19200, 38400, 57600, 74880, 115200, 230400, 460800, 921600].map(r => (
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Select 
                            ...
                            onChange={(e) => handleSerialChange('dataBits', parseInt(e.target.value))}
                            className="h-8 text-xs bg-background"
                        >
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Select 
                            ...
                            onChange={(e) => handleSerialChange('parity', e.target.value)}
                            className="h-8 text-xs bg-background"
                        >
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Select 
                            ...
                            onChange={(e) => handleSerialChange('stopBits', parseInt(e.target.value))}
                            className="h-8 text-xs bg-background"
                        >
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Select 
                            ...
                            onChange={(e) => handleSerialChange('lineEnding', e.target.value)}
                            className="h-8 text-xs bg-background"
                        >
                            <option value="NONE">None</option>
                            <option value="LF">LF (\n)</option>
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Select 
                            ...
                            onChange={(e) => handleSerialChange('flowControl', e.target.value)}
                            className="h-8 text-xs bg-background"
                        >
                            <option value="none">None</option>
                ...
                <div className="space-y-3 border p-3 rounded-md bg-muted/10">
                    <div className="space-y-1.5">
                        ...
                        <Input 
                            ...
                            onChange={(e) => handleNetworkChange('host', e.target.value)}
                            className="h-8 text-xs bg-background"
