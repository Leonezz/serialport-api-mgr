...
import { X, Save, Plus, Trash2, ArrowUp, ArrowDown, Clock } from "lucide-react";
              ...
              <div className="flex flex-col gap-2 min-h-[100px]">
                ...
                {steps.map((step, idx) => {
                  ...
                  return (
                    <div
                      key={step.id}
                      className="flex flex-col gap-2 p-3 rounded-md border border-border bg-muted/10 animate-in fade-in slide-in-from-bottom-2"
                    >
